  ...
  try {
    ...
    about.innerHTML = `
            ...
            <article class="about-content">
                <h2>Sobre mim</h2>
                <p>
                    Minha trajetória na tecnologia começou na prática. 
                    Venho de uma base sólida em Eletrônica pelo SENAI, onde a robótica me ensinou a resolver problemas complexos. 
                    Essa experiência me permitiu liderar equipes de manutenção, desenvolvendo uma visão sistêmica
                     e uma capacidade de tomada de decisão que hoje aplico no desenvolvimento de software.
                </p>
                
                <p>
                    Sou Desenvolvedor Fullstack com experiência em aplicações web e mobile, 
                    atuando em frontend e backend com Python, JavaScript/TypeScript, React, Node.js e AWS. 
                    Sou graduado em Análise e Desenvolvimento de Sistemas pelo Centro Universitário SENAC. 
                    Busco atuar como Desenvolvedor Backend/Fullstack com foco em IA, aplicando boas práticas de engenharia, 
                    APIs escaláveis e soluções em nuvem.
                </p>
